...
float HeartRate_Service::getRValue()
{
  if (!_bufferFull || _redDC == 0 || _irDC == 0 || _irAC == 0)
  {
    return 0.0;
  }
...
void HeartRate_Service::getSignalComponents(float &redAC, float &redDC, float &irAC, float &irDC)
{
  redAC = _redAC;
  redDC = _redDC;
  irAC = _irAC;
