...
static double urand() {
  return (double)random(-10000, 10001) / 10000.0;
}

static void enMetersToLatLon(double east_m, double north_m, double centerLatDeg, double centerLonDeg, double& outLatDeg, double& outLonDeg) {
